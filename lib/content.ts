...
export const initialContent: LodgeContent = {
  ...
  events: [
    {id:"e1", date:"2026-10-13", title:"Τελετή εισδοχής"},
    {id:"e2", date:"2026-11-10", title:"Ομιλία"},
    {id:"e3", date:"2026-12-08", title:"Ομιλία"},
    {id:"e4", date:"2027-01-12", title:"Τελετή διέλευσης"},
    {id:"e5", date:"2027-02-09", title:"Ομιλία"},
    {id:"e6", date:"2027-03-09", title:"Ομιλία"},
    {id:"e7", date:"2027-04-13", title:"Ομιλία"},
    {id:"e8", date:"2027-05-11", title:"Τελετή έγερσης"},
    {id:"e9", date:"2027-06-08", title:"Εγκατάσταση νέων αρχών"},
  ],
  pastMasters: [
