...
export const initialContent: LodgeContent = {
  ...
  events: [
    ...
    {id:"e4", date:"2026-10-13", title:"20:00 — Τελετή εισδοχής. Πρώτη συνεδρία της χρονιάς. Προς εισδοχή είναι οι Νίκος Σταυρουλόπουλος, Δημοσθένης Τζήμος και Παναγιώτης Κατσαιδώνης (3 αμύητοι), και προς Τακτοποίηση ο Διδ. Αδ. Κώστας Ηλιάδης από τη Μεγάλη Στοά Ελλάδος, Στοά Παρθενών (εφόσον η Στοά τους εγκρίνει κατά τα κεκανονισμένα).", image:"", link:""},
